...
const navItems = [
  ...
  { href: "/notes", label: "筆記", labelEn: "Notes", icon: BookOpen, match: (p: string) => p.startsWith("/notes") },
  { href: "/slides", label: "簡報", labelEn: "Slides", icon: Presentation, match: (p: string) => p.startsWith("/slides") },
  { href: "/md-renderer", label: "渲染器", labelEn: "Renderer", icon: FileText, match: (p: string) => p === "/md-renderer" },
]
